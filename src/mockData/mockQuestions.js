export const questions = [
  {
    ...
    stat: {
      answer: `It carried a wheel of cheese into orbit. Prior to the successful liftoff, SpaceX officials hinted that Dragon was carrying special cargo into space, but the company did not reveal the secret payload until after the spacecraft had returned.
    ...
    name: '',
    type: 'questionCard',
    question: `What Marvel character is CEO Elon Musk said to be a portrayal of?`,
    stat: {
      answer: `Musk, who founded SpaceX in 2002, is also the CEO of Tesla Motors and made his initial fortune by co-founding the online payment system PayPal. 
      The entrepreneur has also developed a larger-than-life persona, with admirers calling him the real-life Tony Stark`
    }
  }, {
    name: '',
    type: 'questionCard',
    question: `What is the metophor SpaceX has said to explain the need for reuseable spacecrafts `,
    stat: {
      answer: `A metaphor Elon would frequently use with us is comparing 
      it to throwing away a Boeing 747 after every flight. We simply can't go forward in space exploration if the vehicles don't become reusable.`
    }
  }, {
    name: '',
    type: 'questionCard',
    ...
    stat: {
      answer: `Falcon 9 first-stage landing test were a series of controlled-descent flight tests conducted by SpaceX between 2013 and 2016. Since 2017, the first stage of Falcon 9 missions has been routinely landed if the rocket performance allowed it, and if SpaceX choose to recover the stage.
    ...
    name: '',
    type: 'questionCard',
    question: `From 2013 to 2016, sixteen test flights were conducted Falcon 9 first-stage landing test how many were successful?`,
    stat: {
      answer: `From 2013 to 2016, sixteen test flights were conducted, six of which achieved a soft landing and recovery of the booster.`
    }
  }, {
    name: '',
    type: 'questionCard',
    ...
    stat: {
      answer: `Falcon 9 flight 23 (CRS-8) finally achieved a stable landing at sea in the Atlantic on the drone ship Of Course I Still Love You in April 2016 after four previous attempts ended in destruction of the booster upon impact`
    }
  }
];